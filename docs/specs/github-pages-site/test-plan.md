...
| T7 | Referenced images and the replacement manifest exist | AC-6 | unit | `test/site.test.mjs` | automated |
...
| T10 | Generator, digest, and placeholder behavior remains valid | AC-4, AC-6 | integration | `npm --prefix C:\Users\jong\.agents\skills\create-gh-pages-site test` | automated |
...
| F6 | Artwork placeholders and replacement contract | `public/images/IMAGES.md:1` | T7, T10 | covered |
